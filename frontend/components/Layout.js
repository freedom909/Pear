...
export default function Layout({ children, title = 'Authentication App', description = 'A secure authentication solution' }) {
          ...
          <div className={styles.headerContent}>
            ...
            <nav className={styles.desktopNav}>
              <ul className={styles.navList}>
                ...
                <li>
                  <Link href="/features" className={`${styles.navLink} ${router.pathname === '/features' ? styles.active : ''}`}>
                    Features
                  </Link>
                </li>
                <li>
                  <Link href="/docs" className={`${styles.navLink} ${router.pathname === '/docs' ? styles.active : ''}`}>
                    Documentation
                  </Link>
                </li>
              </ul>
                  ...
                  {isUserMenuOpen && (
                    <div className={styles.userMenu}>
                      <Link href="/dashboard" className={styles.userMenuItem}>
                        <svg xmlns="http://www.w3.org/2000/svg" className={styles.userMenuIcon} viewBox="0 0 20 20" fill="currentColor">
          ...
          {isMenuOpen && (
            <nav className={styles.mobileNav}>
              <ul className={styles.mobileNavList}>
                ...
                <li>
                  <Link href="/docs" className={styles.mobileNavLink} onClick={toggleMenu}>
                    Documentation
                  </Link>
                </li>
                {!user && (
                  <>
                    ...
                    <li>
                      <Link href="/register" className={styles.mobileNavLink} onClick={toggleMenu}>
                        Sign up
                      </Link>
                    </li>
                  </>
                ...
                {user && (
                  <>
                    ...
                    <li>
                      <Link href="/profile" className={styles.mobileNavLink} onClick={toggleMenu}>
                        Profile
                      </Link>
                    </li>
                    <li>
                      <Link href="/settings" className={styles.mobileNavLink} onClick={toggleMenu}>
                        Settings
                      </Link>
                    </li>
                    <li>
