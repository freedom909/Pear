...
export class EnvConfig {
   ...
   */
  static get<K extends keyof typeof EnvConfig.env>(key: K): typeof EnvConfig.env[K] {
    if (!this.env) {
      this.init();
    }
    return this.env[key];
