...
describe('Error Utilities', () => {
  describe('AppError', () => {
    ...
    it('应该创建具有自定义值的错误', () => {
      ...
      const error = new AppError('验证错误', 422, 'VALIDATION_FAILED', true, details);
  ...
  describe('Specific Error Classes', () => {
    ...
    it('应该允许添加详细信息', () => {
      ...
      const error = new ForbiddenError('无权访问此用户资料', 'ACCESS_DENIED', details);
  ...
  describe('createErrorResponse', () => {
    it('应该为AppError创建标准响应', () => {
      const error = new ValidationError('字段验证失败', 'FIELD_VALIDATION', { field: 'email' });
